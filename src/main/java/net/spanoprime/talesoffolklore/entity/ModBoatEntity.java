...
public class ModBoatEntity extends Boat
{
    ...
    public Item getDropItem() {
        ...
        {
            case VIRGINIA_PINE -> ModItems.VIRGINIA_PINE_BOAT.get();
        };
    }
    ...
    protected void defineSynchedData()
    {
        ...
        this.entityData.define(DATA_ID_TYPE, Type.VIRGINIA_PINE.ordinal());
    }
    ...
    public static enum Type implements StringRepresentable {
        VIRGINIA_PINE(ModBlocks.VIRGINIA_PINE_PLANKS.get(), "virginia_pine");
        ...
        public static ModBoatEntity.Type byName(String pName) {
            return CODEC.byName(pName, VIRGINIA_PINE);
        }
    }
}
